...
import MiddleContainer from "@/app/_components/admin/schooling/ScholMidContainer";
import ScholTotals from "@/app/_components/admin/schooling/ScholTotals";
import BasicTable from "@/app/_components/admin/schooling/ScholTable";
