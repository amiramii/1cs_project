...
import { AdminLikeDashboardCharts } from "@/app/_components/dashboard/DashboardCharts";
...
import {
  ...
  type AdminLikeDashboardCharts as AdminChartsData,
...
export default function AdminDashboardView() {
  ...
  return (
    ...
    <div className="mx-auto w-full min-w-0 max-w-6xl space-y-8">
      ...
      <ModuleExclusionPolicyCard canEdit />
